...
class ZoomWindowSettingsDialog(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val enabledSwitch = view.findViewById<SwitchCompat>(R.id.pdfPaint_zoom_window_enabled)
        val slider = view.findViewById<Slider>(R.id.pdfPaint_zoom_window_slider)
        val sliderTextView = view.findViewById<TextView>(R.id.pdfPaint_zoom_window_slider_progress)
