...
import org.hammel.paintpdf.LanguageHelper
import org.hammel.paintpdf.MainActivity
import paintpdf.R
import org.hammel.paintpdf.contract.LayerContracts
import org.hammel.paintpdf.iotasks.OpenRasterFileFormatConversion.Companion.mainActivity
import org.hammel.paintpdf.model.MAX_LAYER_OPACITY_PERCENTAGE
...
class LayerAdapter(
    ...
    inner class LayerViewHolder(
        ...
        private val layerBackground: LinearLayout = itemView.findViewById(R.id.pdfPaint_item_layer)
        private val imageView: ImageView = itemView.findViewById(R.id.pdfPaint_item_layer_image)
        private val dragHandle: ImageView = itemView.findViewById(R.id.pdfPaint_layer_drag_handle)
        private val opacitySeekBar: SeekBar = itemView.findViewById(R.id.pdfPaint_layer_opacity_seekbar)
        private val opacityEditText: AppCompatEditText = itemView.findViewById(R.id.pdfPaint_layer_opacity_value)
        private var currentBitmap: Bitmap? = null
        private val layerVisibilityCheckbox: CheckBox = itemView.findViewById(R.id.pdfPaint_checkbox_layer)
        ...
        override fun setMergable() = layerBackground.setBackgroundResource(R.color.pdfPaint_color_merge_layer)
