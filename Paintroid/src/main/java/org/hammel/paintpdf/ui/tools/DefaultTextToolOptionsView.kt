...
class DefaultTextToolOptionsView(rootView: ViewGroup) : TextToolOptionsView {
    ...
    init {
        ...
        topLayout = textToolView.findViewById(R.id.pdfPaint_text_top_layout)
        bottomLayout = textToolView.findViewById(R.id.pdfPaint_text_bottom_layout)
        textEditText = textToolView.findViewById(R.id.pdfPaint_text_tool_dialog_input_text)
        fontList = textToolView.findViewById(R.id.pdfPaint_text_tool_dialog_list_font)
        underlinedToggleButton =
            textToolView.findViewById(R.id.pdfPaint_text_tool_dialog_toggle_underlined)
        italicToggleButton =
            textToolView.findViewById(R.id.pdfPaint_text_tool_dialog_toggle_italic)
        boldToggleButton = textToolView.findViewById(R.id.pdfPaint_text_tool_dialog_toggle_bold)
        fontSizeText = textToolView.findViewById(R.id.pdfPaint_font_size_text)
        ...
        val viewShapeSizeLayout =
            textToolView.findViewById<LinearLayout>(R.id.pdfPaint_layout_text_tool_options_view_shape_size)
        textToolOptionsViewShapeSizeChip = viewShapeSizeLayout.findViewById(R.id.pdfPaint_fill_shape_size_text)
        val changeShapeSizeLayout =
            textToolView.findViewById<LinearLayout>(R.id.pdfPaint_layout_text_tool_change_size_shape_size)
