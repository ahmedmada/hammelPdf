...
import org.hammel.paintpdf.tools.options.TransformToolOptionsView
...
class DefaultTransformToolOptionsView(rootView: ViewGroup) : TransformToolOptionsView {
    ...
    init {
        ...
        widthEditText = optionsView.findViewById(R.id.pdfPaint_transform_width_value)
        heightEditText = optionsView.findViewById(R.id.pdfPaint_transform_height_value)
        resizeSeekBar = optionsView.findViewById(R.id.pdfPaint_transform_resize_seekbar)
        percentageText = optionsView.findViewById(R.id.pdfPaint_transform_resize_percentage_text)
        ...
        optionsView.findViewById<View>(R.id.pdfPaint_transform_auto_crop_btn)
            .setOnClickListener {
                callback?.autoCropClicked()
            }
        optionsView.findViewById<View>(R.id.pdfPaint_transform_set_center_btn)
            .setOnClickListener {
                callback?.setCenterClicked()
            }
        optionsView.findViewById<View>(R.id.pdfPaint_transform_rotate_left_btn)
            .setOnClickListener {
                callback?.rotateCounterClockwiseClicked()
            }
        optionsView.findViewById<View>(R.id.pdfPaint_transform_rotate_right_btn)
            .setOnClickListener {
                callback?.rotateClockwiseClicked()
            }
        optionsView.findViewById<View>(R.id.pdfPaint_transform_flip_horizontal_btn)
            .setOnClickListener {
                callback?.flipHorizontalClicked()
            }
        optionsView.findViewById<View>(R.id.pdfPaint_transform_flip_vertical_btn)
            .setOnClickListener {
                callback?.flipVerticalClicked()
            }
        optionsView.findViewById<View>(R.id.pdfPaint_transform_apply_resize_btn)
            .setOnClickListener {
                hideKeyboard()
