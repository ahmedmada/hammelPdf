...
class DefaultZoomWindowController
    ...
    private val zoomWindowDiameter = activity.resources.getDimensionPixelSize(R.dimen.pdfPaint_zoom_window_diameter)
    ...
    init {
        ...
        greyBackgroundCanvas.drawColor(
            activity.resources.getColor(R.color.pdfPaint_main_drawing_surface_background)
        )
    ...
    private val zoomWindow: RelativeLayout =
        activity.findViewById(R.id.pdfPaint_zoom_window)
    private val zoomWindowImage: ImageView =
        activity.findViewById(R.id.pdfPaint_zoom_window_image)
