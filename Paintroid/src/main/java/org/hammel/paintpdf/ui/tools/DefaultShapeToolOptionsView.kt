...
class DefaultShapeToolOptionsView(rootView: ViewGroup) : ShapeToolOptionsView {
    ...
    init {
        ...
        shapeToolView.run {
            squareButton = findViewById(R.id.pdfPaint_shapes_square_btn)
            circleButton = findViewById(R.id.pdfPaint_shapes_circle_btn)
            heartButton = findViewById(R.id.pdfPaint_shapes_heart_btn)
            starButton = findViewById(R.id.pdfPaint_shapes_star_btn)
            fillButton = findViewById(R.id.pdfPaint_shape_ibtn_fill)
            outlineButton = findViewById(R.id.pdfPaint_shape_ibtn_outline)
            shapeToolDialogTitle = findViewById(R.id.pdfPaint_shape_tool_dialog_title)
            shapeToolFillOutline = findViewById(R.id.pdfPaint_shape_tool_fill_outline)
            outlineView = findViewById(R.id.pdfPaint_outline_view_border)
            outlineTextView = findViewById(R.id.pdfPaint_outline_view_text_view)
            outlineWidthSeekBar = findViewById(R.id.pdfPaint_shape_stroke_width_seek_bar)
            outlineWidthEditText = findViewById(R.id.pdfPaint_shape_outline_edit)
            shapeSizeChip = findViewById<LinearLayout>(R.id.pdfPaint_layout_shape_tool_options_view_shape_size).findViewById(R.id.pdfPaint_fill_shape_size_text)
            changeSizeShapeSizeChip = findViewById<LinearLayout>(R.id.pdfPaint_layout_shape_tool_change_size_shape_size).findViewById(R.id.pdfPaint_fill_shape_size_text)
            shapeToolOptionsView = findViewById(R.id.pdfPaint_layout_shape_tool_options)
        }
