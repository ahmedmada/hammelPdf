...
class DefaultImportToolOptionsView(rootView: ViewGroup) : ImportToolOptionsView {
    ...
    init {
        ...
        shapeSizeChip = importToolOptionsView.findViewById(R.id.pdfPaint_fill_shape_size_text)
        shapeSizeLayout = importToolOptionsView.findViewById(R.id.pdfPaint_layout_import_tool_shape_size)
    }
}
