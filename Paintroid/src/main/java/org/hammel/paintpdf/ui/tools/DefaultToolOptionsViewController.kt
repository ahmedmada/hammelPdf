...
import paintpdf.R
import org.hammel.paintpdf.common.ANIMATION_DURATION
...
import org.hammel.paintpdf.tools.options.ToolOptionsVisibilityController
...
class DefaultToolOptionsViewController(
    ...
    private val bottomNavigation: ViewGroup =
        activity.findViewById(R.id.pdfPaint_main_bottom_navigation)
    private val mainToolOptions: ViewGroup =
        activity.findViewById(R.id.pdfPaint_layout_tool_options)
    private val topBarSpecificViewCheckmark: View =
        activity.findViewById(R.id.pdfPaint_btn_top_checkmark)
    private val topBar: View =
        activity.findViewById(R.id.pdfPaint_layout_top_bar)
    ...
    override val toolSpecificOptionsLayout: ViewGroup
        get() = activity.findViewById(R.id.pdfPaint_layout_tool_specific_options)
