...
import org.hammel.paintpdf.listener.DrawingSurfaceListener
import org.hammel.paintpdf.listener.DrawingSurfaceListener.DrawingSurfaceListenerCallback
...
import org.hammel.paintpdf.ui.zoomwindow.DefaultZoomWindowController.Constants
...
//    private lateinit var sharedPreferences: UserPreferences
    ...
    init {
        ...
        bgColor = ContextCompat.getColor(
            context,
            R.color.pdfPaint_main_drawing_surface_background
        )
        framePaint.color = Color.BLACK
        framePaint.style = Paint.Style.STROKE
        framePaint.xfermode = PorterDuffXfermode(PorterDuff.Mode.SRC)
        val checkerboard =
            BitmapFactory.decodeResource(resources, R.drawable.backgrount_white)
...
//        this.fragmentManager = fragmentManager
        ...
        drawingSurfaceListener.setZoomController(zoomController)
