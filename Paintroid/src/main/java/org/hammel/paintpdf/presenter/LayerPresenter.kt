...
import org.hammel.paintpdf.common.MEGABYTE_IN_BYTE
import org.hammel.paintpdf.common.MINIMUM_HEAP_SPACE_FOR_NEW_LAYER
...
import org.hammel.paintpdf.ui.dragndrop.DragAndDropPresenter
...
class LayerPresenter(
    ...
    override fun getLayerItem(position: Int): LayerContracts.Layer? {
        if (isPositionValid(position)) {
            ...
            Log.w(
                "LayerPresenter.kt",
                "LayerPresenter.getLayerItem(position) - tried to access position out of range of the layers array!"
            )
            return null
        }
    }
    ...
    override fun changeLayerOpacity(position: Int, opacityPercentage: Int) {
        ...
        commandManager.addCommand(
            commandFactory.createLayerOpacityCommand(
                position,
                opacityPercentage
            )
        )
